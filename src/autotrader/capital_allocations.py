...
INTERNATIONAL_SIM_CAPITAL = 1000.0
METALS_PAPER_CAPITAL = 1000.0

PILLAR_ALLOCATIONS = {
    PILLAR_EQUITIES: 1000.0,
    PILLAR_FOREX: 1000.0,
    PILLAR_CRYPTO: 1000.0,
    PILLAR_METALS: 1000.0,
    PILLAR_IBKR_GLOBAL: 1000.0,
}
...
def validate_kalshi_reservation(*, predictions_committed: float, perps_committed: float,
    ...
    return all(value >= 0 for value in values) and sum(values) <= KALSHI_DEMO_BASE_CAPITAL + realized_profit
