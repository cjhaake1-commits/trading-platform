...
from .capital_allocations import KALSHI_DEMO_BASE_CAPITAL, PILLAR_ALLOCATIONS, SIX_PILLAR_BASE_CAPITAL
...
def publish_status(status: dict[str, object] | None = None) -> dict[str, object]:
    ...
    result = {"generated_at_utc": _now(), "runtime_instance_id": boundary["runtime_instance_id"],
              ...
              "capital": {"authorized_strategy_capital": SIX_PILLAR_BASE_CAPITAL,
